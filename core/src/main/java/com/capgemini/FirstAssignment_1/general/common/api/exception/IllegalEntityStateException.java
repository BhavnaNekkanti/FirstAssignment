package com.capgemini.FirstAssignment_1.general.common.api.exception;

import com.capgemini.FirstAssignment_1.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link com.capgemini.FirstAssignment_1.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the FirstAssignment_1Entity entity.
