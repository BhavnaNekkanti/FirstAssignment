package com.capgemini.FirstAssignment_1.general.logic.base;
...
public abstract class AbstractComponentFacade extends AbstractBeanMapperSupport {
   ...
   */
  protected <T extends ApplicationPersistenceEntity, E extends PersistenceEntity<?>> PaginatedListTo<T> mapPaginatedEntityList(
